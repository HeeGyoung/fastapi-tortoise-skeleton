...
from services.enums.user import AccountAuthenticated, AccountStatus, AccountLevel
...
class User(Model, TimeStampMixin):
    ...
    status: AccountStatus = fields.BooleanField(enum_type=AccountStatus, default=AccountStatus.ACTIVE)
