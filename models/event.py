...
class Event(Model, TimeStampMixin):
    ...
    end_page_url: str = fields.CharField(max_length=2048, null=True)
    banner_image_url: str = fields.CharField(max_length=2048, null=True)
    list_image_url: str = fields.CharField(max_length=2048, null=True)
    is_delete: BooleanField = fields.BooleanField(default=True, null=True)
